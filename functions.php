...
function lam_register_scripts() {
	...
	wp_enqueue_script( 'lam-js', get_template_directory_uri() . '/assets/js/materialize.min.js', null, $theme_version, true );
    wp_enqueue_script( 'lam-event', get_template_directory_uri() . '/assets/js/events.js', null, $theme_version, true );
