...
function lam_register_scripts() {
    ...
    wp_enqueue_script( 'lam-js', get_template_directory_uri() . '/assets/js/materialize.min.js', array('jquery'), $theme_version, false );
    ...
    wp_enqueue_script( 'lam-event', get_template_directory_uri() . '/assets/js/events.js', array('jquery','lam-js'), true );
